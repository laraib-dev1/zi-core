...
const DEFAULT_SECTIONS = [
  ...
  { sectionId: "feature-cards", label: "Feature Cards", order: 9 },
  { sectionId: "cta-banner-3", label: "CTA Banner 3", order: 10 },
  { sectionId: "other-pages", label: "Other Pages (Detail Sidebar)", order: 11 },
  { sectionId: "testimonials", label: "Testimonials", order: 12 },
  { sectionId: "faqs", label: "FAQs", order: 13 },
  { sectionId: "help-banner-1", label: "Help Banner 1", order: 14 },
  { sectionId: "contact", label: "Contact", order: 15 },
  { sectionId: "cta-banner-4", label: "CTA Banner 4", order: 16 },
  { sectionId: "scale-operations", label: "Scale Operations Banner", order: 17 },
  { sectionId: "feature-service", label: "Feature Service Card", order: 18 },
  { sectionId: "hero-business", label: "Hero Business", order: 19 },
  { sectionId: "team", label: "Team", order: 20 },
  { sectionId: "unlock-potential", label: "Unlock Potential", order: 21 },
  { sectionId: "call-to-action", label: "Call To Action", order: 22 },
  { sectionId: "features-details", label: "Features Details", order: 23 },
  { sectionId: "clients", label: "Clients", order: 24 },
  { sectionId: "excellence", label: "Excellence", order: 25 },
  { sectionId: "help-banner-2", label: "Help Banner 2 (Card)", order: 26 },
  { sectionId: "event-banner", label: "Event Banner", order: 27 },
  { sectionId: "limited-offer", label: "Limited Offer Banner", order: 28 },
  { sectionId: "coming-soon", label: "Coming Soon", order: 29 },
];
